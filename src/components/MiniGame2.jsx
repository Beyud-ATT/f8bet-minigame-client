    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50">
      <div className="relative w-[90%] max-w-[400px] p-6 rounded-[15.678px] bg-[rgba(255,255,255,0.95)] shadow-[0px_0px_20px_0px_rgba(255,255,255,0.25)]">
        ...
        <div className="text-center mb-4">
          ...
          {question?.suggest && (
            <p className="text-[#26A8DF] italic">Gợi ý: {question.suggest}</p>
          )}
        </div>
        {isOpenPopup && (
          <div
        ...
        <div className="flex justify-between items-center">
          ...
          {isLastQuestion ? (
            ...
            <button
              ...
              className={`px-4 py-2 rounded bg-[#26A8DF] hover:bg-[#0087A4] text-white transition-colors ${
