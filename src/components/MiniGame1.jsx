    ...
    <>
      <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50">
        <div className="relative w-[90%] max-w-[400px] p-6 rounded-[15.678px] bg-[rgba(255,255,255,0.95)] shadow-[0px_0px_20px_0px_rgba(255,255,255,0.25)]">
          ...
          {isContinuingSession && (
            <div className="absolute top-0 left-0 right-0 bg-[#26A8DF] text-white text-center py-1 text-sm">
              Tiếp tục phiên trả lời trước
            </div>
          )}
          {/* Countdown Timer */}
          <div className="absolute top-0 left-0 right-0 pt-2">
            <CountdownTimer
          ...
          <div className="flex justify-between items-center my-5">
            <div className="text-[#26A8DF] font-roboto text-base font-bold">
          ...
          <div className="space-y-3">
            {question?.options.map((option, index) => {
              ...
              return (
                <label
                  key={index}
                  className={`flex items-center gap-3 p-3 rounded-lg border border-[#26A8DF] cursor-pointer hover:bg-[#26A8DF] 
          ${isSelected ? "bg-[#26A8DF]" : ""}`}
                >
                  <input
                  ...
                  {option.image ? (
                    ...
                    <span
                      className={`text-[#262626] font-roboto text-[15.479px] font-normal ${
                        isSelected ? "text-white" : ""
                      }`}
                    >
                      {option.text}
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            {isLastQuestion ? (
              <button
                ...
                className="h-[46px] px-4 text-white scale-100 hover:scale-105 transform transition-all duration-300 cursor-pointer"
                style={{
                  borderRadius: "15.749px",
                  border: "0.477px solid #FFF",
