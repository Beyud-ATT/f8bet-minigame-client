    ...
    <div className="fixed inset-0 flex items-center justify-center z-[60] bg-black/50">
      <div className="relative w-[90%] max-w-[400px] p-4 rounded-[15px] bg-white">
        <div className="flex justify-between items-center mb-4">
          ...
          >
            <span className="text-white font-bold">lịch sử mini game</span>
          </header>
        </div>
          ...
          {loading ? (
            ...
            gameHistory.map((game, index) => {
              ...
              return (
                <div
                  key={index}
                  className="p-4 border border-[#2C70DE] rounded-lg bg-gray-50 cursor-pointer transition-all"
                  onClick={() => toggleExpand(index)}
                >
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="font-medium text-[#116DFF]">
                      {game.category == 1
                        ? "Trả lời câu hỏi"
                        : "Đuổi hình đoán chữ"}
                    </h4>
                  ...
                  <div className="text-sm text-[#000345]">
                    ...
                    {game.promo_code && (
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        >
                          <code className="bg-[#D1E7FF] px-2 py-1 rounded">
                            {game.promo_code}
                          </code>
                              ...
                              <p>
                                ...
                                <span className="text-green-700">
                                  {game.category == 2
                                    ...
                                    : Array.isArray(
                                        correctData?.correctAnswersText
                                      )
                                    ? correctData.correctAnswersText.join(", ")
                                    : correctData?.correctAnswersText}
                                </span>
                              </p>
                            )} */}
